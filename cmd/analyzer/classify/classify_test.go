...
func TestRecognizerShapes(t *testing.T) {
	cases := []struct {
		...
		{IsNonSecretConnString, "jdbc-no-cred-rfc1918", "jdbc:postgresql://10.0.0.5:5432/app", true},
		{IsNonSecretConnString, "jdbc-public-host-no-cred-kept", "jdbc:sqlserver://db.prod.example.com:1433;databaseName=app", false},
		{IsNonSecretConnString, "jdbc-public-host-short-exotic-secret-kept", "jdbc:mysql://db.prod/db?x=aB3xKp9Qm2Lr7", false},
		{IsNonSecretConnString, "jdbc-internal-embedded-password-kept", "jdbc:sqlserver://localhost:1;password=hunter2", false},
		{IsNonSecretConnString, "jdbc-internal-exotic-key-highentropy-kept", "jdbc:mysql://localhost/db?x=AKIANZHP27R2JXHL67Q7AbCd", false},
		{IsNonSecretConnString, "jdbc-internal-userinfo-password-kept", "jdbc:postgresql://app:s3cretP4ss@localhost:5432", false},
		{IsNonSecretConnString, "jdbc-internal-sign-param-suppressed", "jdbc:sqlserver://localhost:1;signMode=full;encrypt=true", true},
